      ...
      <div className={classes.container}>
        <div className={classes.row}>
          ...
          <div className={classes.footerList}>
            ...
            <Link to="/search" className={classes.footerLink}>Search</Link>
            <Link to="/discover" className={classes.footerLink}>Discover</Link>
            {isLoggedIn && <Link to="/my-list" className={classes.footerLink}>My List</Link>}
